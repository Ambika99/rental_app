...
public class RoyalEnfield extends android.support.v4.app.Fragment {
    private String title;
    private int image;

    public static RoyalEnfield newInstance(String title, int image) {

        RoyalEnfield fragment = new RoyalEnfield();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getActivity(),royal_enfield_price.class);
