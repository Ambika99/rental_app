...
public class royal_enfield_price extends AppCompatActivity implements DatePickerDialog.OnDateSetListener,TimePickerDialog.OnTimeSetListener,AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_royal_enfield_price);
        ...
        switch (selectedID){
            case R.id.radioVIT :
            {
                proceedBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent i = new Intent(royal_enfield_price.this,vitian_form.class);
                        startActivity(i);
                    }
                });
            }
            ...
            case R.id.radioNonVIT :
            {
                proceedBtn.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent i1 = new Intent(royal_enfield_price.this,non_vitian_form.class);
                        startActivity(i1);
                    }
                });
            }
        ...
        startDatePick.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(royal_enfield_price.this,royal_enfield_price.this,startYear,startMonth,startDay);
    ...
    public void onDateSet(DatePicker datePicker, int i, int i1, int i2) {
        ...
        TimePickerDialog timePickerDialog = new TimePickerDialog(royal_enfield_price.this, royal_enfield_price.this, startHour, startMinute, DateFormat.is24HourFormat(this));
